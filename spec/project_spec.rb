...
describe Project do
  describe '#title' do
    it 'returns the project title' do
      project = Project.new({:title => 'Teaching Kids to Code', :name => nil, :project_id => 7, :id => nil})
  ...
  describe '#volunteers' do
    it 'returns all volunteers for a specific project' do
      project = Project.new({:title => 'Teaching Kids to Code', :name => nil, :project_id => 8, :id => nil})
      project.save()
      volunteer1 = Volunteer.new({:name => 'Jasmine', :project_id => 8, :id => nil})
      volunteer1.save()
      volunteer2 = Volunteer.new({:name => 'Joe', :project_id => 8, :id => nil})
      volunteer2.save()
  ...
  describe '#update' do
    it 'allows a user to update a project' do
      project = Project.new({:title => 'Teaching Kids to Code', :name => nil, :project_id => 8, :id => nil})
      project.save()
      project.update({:title => 'Teaching Ruby to Kids', :name => nil, :project_id => 11, :id => nil})
